  ...
  return (
    <>
      ...
      <div className="py-8 md:py-12 text-foreground scanline-root relative w-[calc(100svw-30px)] mx-auto min-h-svh">
        ...
        <footer className="flex justify-center py-12 md:py-16 border-t border-border mt-16">
          <Link
            href="https://github.com/InSpaceHQ/crucible"
            target="_blank"
            className="inline-flex items-center gap-2 font-mono text-sm text-foreground/60 hover:text-foreground transition-colors"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
